    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="page-title text-center mb-5">
                <h1>Elenco Prestazioni Cassa Edile di Rieti</h1>
                <p class="lead">Prestazioni della Cassa Edile di Rieti e provincia</p>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (serviceModalEl) {
            ...
            const modalDescriptionEl = document.getElementById('serviceModalDescription'); // Corretto ID
            ...
            document.querySelectorAll('.btn-show-guide').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    if (activeRequestData) {
                        ...
                        // Logica per nuova richiesta per Cassa Edile Rieti:
                        // non mostra l'elenco dei documenti (sarà il funzionario a richiederli se necessario)
                        // ma mostra sempre il pulsante per procedere.
