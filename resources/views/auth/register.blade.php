            ...
            <div class="card page-title">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- Il tipo di account viene passato dal controller e inserito come campo nascosto --}}
                        ...
                        {{-- I campi specifici per il lavoratore vengono mostrati solo se il tipo di account è 'worker' --}}
...
@push('scripts')
<script>
// Lo script per mostrare/nascondere i campi non è più necessario
// in quanto la logica è gestita lato server con Blade.
</script>
@endpush
